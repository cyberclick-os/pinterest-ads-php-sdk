...
interface LoggerInterface {
  ...
  public function logRequest(string $level, RequestInterface $request, array $context = array());
  public function logResponse(string $level, ResponseInterface $response, array $context = array());
}
